...
<head>
	...
	<meta name="description" content="Welcome to Team 8: The home of web design. For custom software, ecommerce, web development, & digital marketing - Call us now 01656 513 046" />
	<!-- Favicons -->
	...
	<?php
		...
		echo $this->Html->css('blog-slider');
...
<div id="home-header-wrapper">
	...
	<div id="home-header" class="large-container grid">
		<div class="index-header-intro">
			<h2 class="sts-typed"><span class="line-1 anim-typewriter"></span></h2>
			<p>Affordable web design with your business in mind, <strong>from <span>&pound;299</span></strong></p>
			<a href="<?php echo $this->webroot?>services/web-design#begin" class="blue-btn">Get A Free Quote</a>
		</div>
