...
require_once ROOT.'/app/Vendor/ZendFramework-minimal-2.2.1/library/Zend/Loader/ClassMapAutoloader.php';
$loader = new Zend\Loader\ClassMapAutoloader();
$loader->registerAutoloadMap(ROOT.'/app/Vendor/ZendFramework-minimal-2.2.1/library/Zend/.classmap.php');
$loader->register();
